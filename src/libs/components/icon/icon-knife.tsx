export interface IconKnife {
    size?: number;
    className?: string;
}
export const IconKnife = ({ size = 56, className }: IconKnife) => {
    return <svg
        width={size}
        height={size}
        ...
        <rect opacity="0.01" width="56" height="56" />
        <g clip-path="url(#clip0_0_172)">
            <g clip-path="url(#clip1_0_172)">
                <path d="M11.0234 46.2289C9.93441 47.316 9.93624 49.0846 11.0288 50.1788C12.123 51.2714 13.8917 51.2731 14.9805 50.1844L23.6829 41.4822L19.7255 37.525L11.0234 46.2289Z" />
        ...
        <defs>
            <clipPath id="clip0_0_172">
                <rect width="53.0001" height="45" transform="translate(2 6)" />
            </clipPath>
